...
public class ModBlocks {
    ...
    public static Block AMBERGLASS = new StainedGlassBlock(null, GLASS.notSolid()).setRegistryName("amber_stained_glass");
    public static Block BEIGEGLASS = new StainedGlassBlock(null, GLASS.notSolid()).setRegistryName("beige_stained_glass");
    public static Block CREAMGLASS = new StainedGlassBlock(null, GLASS.notSolid()).setRegistryName("cream_stained_glass");
    public static Block DARKGREENGLASS = new StainedGlassBlock(null, GLASS.notSolid()).setRegistryName("dark_green_stained_glass");
    public static Block FORESTGREENGLASS = new StainedGlassBlock(null, GLASS.notSolid()).setRegistryName("forest_green_stained_glass");
    public static Block HOTPINKGLASS = new StainedGlassBlock(null, GLASS.notSolid()).setRegistryName("hot_pink_stained_glass");
    public static Block INDIGOGLASS = new StainedGlassBlock(null, GLASS.notSolid()).setRegistryName("indigo_stained_glass");
    public static Block MAROONGLASS = new StainedGlassBlock(null, GLASS.notSolid()).setRegistryName("maroon_stained_glass");
    public static Block NAVYGLASS = new StainedGlassBlock(null, GLASS.notSolid()).setRegistryName("navy_stained_glass");
    public static Block OLIVEGLASS = new StainedGlassBlock(null, GLASS.notSolid()).setRegistryName("olive_stained_glass");
    public static Block PALEGREENGLASS = new StainedGlassBlock(null, GLASS.notSolid()).setRegistryName("pale_green_stained_glass");
    public static Block PALEPINKGLASS = new StainedGlassBlock(null, GLASS.notSolid()).setRegistryName("pale_pink_stained_glass");
    public static Block PALEYELLOWGLASS = new StainedGlassBlock(null, GLASS.notSolid()).setRegistryName("pale_yellow_stained_glass");
    public static Block SKYBLUEGLASS = new StainedGlassBlock(null, GLASS.notSolid()).setRegistryName("sky_blue_stained_glass");
    public static Block SLATEGRAYGLASS = new StainedGlassBlock(null, GLASS.notSolid()).setRegistryName("slate_gray_stained_glass");
    public static Block VIOLETGLASS = new StainedGlassBlock(null, GLASS.notSolid()).setRegistryName("violet_stained_glass");
    public static Block AMBERPANE = new StainedGlassPaneBlock(null, GLASS.notSolid()).setRegistryName("amber_stained_glass_pane");
    public static Block BEIGEPANE = new StainedGlassPaneBlock(null, GLASS.notSolid()).setRegistryName("beige_stained_glass_pane");
    public static Block CREAMPANE = new StainedGlassPaneBlock(null, GLASS.notSolid()).setRegistryName("cream_stained_glass_pane");
    public static Block DARKGREENPANE = new StainedGlassPaneBlock(null, GLASS.notSolid()).setRegistryName("dark_green_stained_glass_pane");
    public static Block FORESTGREENPANE = new StainedGlassPaneBlock(null, GLASS.notSolid()).setRegistryName("forest_green_stained_glass_pane");
    public static Block HOTPINKPANE = new StainedGlassPaneBlock(null, GLASS.notSolid()).setRegistryName("hot_pink_stained_glass_pane");
    public static Block INDIGOPANE = new StainedGlassPaneBlock(null, GLASS.notSolid()).setRegistryName("indigo_stained_glass_pane");
    public static Block MAROONPANE = new StainedGlassPaneBlock(null, GLASS.notSolid()).setRegistryName("maroon_stained_glass_pane");
    public static Block NAVYPANE = new StainedGlassPaneBlock(null, GLASS.notSolid()).setRegistryName("navy_stained_glass_pane");
    public static Block OLIVEPANE = new StainedGlassPaneBlock(null, GLASS.notSolid()).setRegistryName("olive_stained_glass_pane");
    public static Block PALEGREENPANE = new StainedGlassPaneBlock(null, GLASS.notSolid()).setRegistryName("pale_green_stained_glass_pane");
    public static Block PALEPINKPANE = new StainedGlassPaneBlock(null, GLASS.notSolid()).setRegistryName("pale_pink_stained_glass_pane");
    public static Block PALEYELLOWPANE = new StainedGlassPaneBlock(null, GLASS.notSolid()).setRegistryName("pale_yellow_stained_glass_pane");
    public static Block SKYBLUEPANE = new StainedGlassPaneBlock(null, GLASS.notSolid()).setRegistryName("sky_blue_stained_glass_pane");
    public static Block SLATEGRAYPANE = new StainedGlassPaneBlock(null, GLASS.notSolid()).setRegistryName("slate_gray_stained_glass_pane");
    public static Block VIOLETPANE = new StainedGlassPaneBlock(null, GLASS.notSolid()).setRegistryName("violet_stained_glass_pane");
