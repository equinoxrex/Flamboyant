...
public class ModBlocks {
    ...
    public static Block AMBERGLASS = new GlassBlock(GLASS).setRegistryName("amber_stained_glass");
    public static Block BEIGEGLASS = new GlassBlock(GLASS).setRegistryName("beige_stained_glass");
    public static Block CREAMGLASS = new GlassBlock(GLASS).setRegistryName("cream_stained_glass");
    public static Block DARKGREENGLASS = new GlassBlock(GLASS).setRegistryName("dark_green_stained_glass");
    public static Block FORESTGREENGLASS = new GlassBlock(GLASS).setRegistryName("forest_green_stained_glass");
    public static Block HOTPINKGLASS = new GlassBlock(GLASS).setRegistryName("hot_pink_stained_glass");
    public static Block INDIGOGLASS = new GlassBlock(GLASS).setRegistryName("indigo_stained_glass");
    public static Block MAROONGLASS = new GlassBlock(GLASS).setRegistryName("maroon_stained_glass");
    public static Block NAVYGLASS = new GlassBlock(GLASS).setRegistryName("navy_stained_glass");
    public static Block OLIVEGLASS = new GlassBlock(GLASS).setRegistryName("olive_stained_glass");
    public static Block PALEGREENGLASS = new GlassBlock(GLASS).setRegistryName("pale_green_stained_glass");
    public static Block PALEPINKGLASS = new GlassBlock(GLASS).setRegistryName("pale_pink_stained_glass");
    public static Block PALEYELLOWGLASS = new GlassBlock(GLASS).setRegistryName("pale_yellow_stained_glass");
    public static Block SKYBLUEGLASS = new GlassBlock(GLASS).setRegistryName("sky_blue_stained_glass");
    public static Block SLATEGRAYGLASS = new GlassBlock(GLASS).setRegistryName("slate_gray_stained_glass");
    public static Block VIOLETGLASS = new GlassBlock(GLASS).setRegistryName("violet_stained_glass");
    public static Block AMBERPANE = new PaneBlock(GLASS).setRegistryName("amber_stained_glass_pane");
    public static Block BEIGEPANE = new PaneBlock(GLASS).setRegistryName("beige_stained_glass_pane");
    public static Block CREAMPANE = new PaneBlock(GLASS).setRegistryName("cream_stained_glass_pane");
    public static Block DARKGREENPANE = new PaneBlock(GLASS).setRegistryName("dark_green_stained_glass_pane");
    public static Block FORESTGREENPANE = new PaneBlock(GLASS).setRegistryName("forest_green_stained_glass_pane");
    public static Block HOTPINKPANE = new PaneBlock(GLASS).setRegistryName("hot_pink_stained_glass_pane");
    public static Block INDIGOPANE = new PaneBlock(GLASS).setRegistryName("indigo_stained_glass_pane");
    public static Block MAROONPANE = new PaneBlock(GLASS).setRegistryName("maroon_stained_glass_pane");
    public static Block NAVYPANE = new PaneBlock(GLASS).setRegistryName("navy_stained_glass_pane");
    public static Block OLIVEPANE = new PaneBlock(GLASS).setRegistryName("olive_stained_glass_pane");
    public static Block PALEGREENPANE = new PaneBlock(GLASS).setRegistryName("pale_green_stained_glass_pane");
    public static Block PALEPINKPANE = new PaneBlock(GLASS).setRegistryName("pale_pink_stained_glass_pane");
    public static Block PALEYELLOWPANE = new PaneBlock(GLASS).setRegistryName("pale_yellow_stained_glass_pane");
    public static Block SKYBLUEPANE = new PaneBlock(GLASS).setRegistryName("sky_blue_stained_glass_pane");
    public static Block SLATEGRAYPANE = new PaneBlock(GLASS).setRegistryName("slate_gray_stained_glass_pane");
    public static Block VIOLETPANE = new PaneBlock(GLASS).setRegistryName("violet_stained_glass_pane");
