...
public class FlamboyantBedBlock extends HorizontalBlock {
    ...
    public FlamboyantBedBlock(Block.Properties properties) {
        super(properties);
    ...
    public static Direction func_220174_a(IBlockReader p_220174_0_, BlockPos p_220174_1_) {
        ...
        return blockstate.getBlock() instanceof net.minecraft.block.BedBlock ? blockstate.get(HORIZONTAL_FACING) : null;
    }
