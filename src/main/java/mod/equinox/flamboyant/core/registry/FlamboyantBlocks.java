...
public class FlamboyantBlocks {
	...
	{
		RenderTypeLookup.setRenderLayer(AMBER_STAINED_GLASS.get(),RenderType.translucent());
		RenderTypeLookup.setRenderLayer(BEIGE_STAINED_GLASS.get(),RenderType.translucent());
		RenderTypeLookup.setRenderLayer(CREAM_STAINED_GLASS.get(),RenderType.translucent());
		RenderTypeLookup.setRenderLayer(DARK_GREEN_STAINED_GLASS.get(),RenderType.translucent());
		RenderTypeLookup.setRenderLayer(FOREST_GREEN_STAINED_GLASS.get(),RenderType.translucent());
		RenderTypeLookup.setRenderLayer(HOT_PINK_STAINED_GLASS.get(),RenderType.translucent());
		RenderTypeLookup.setRenderLayer(INDIGO_STAINED_GLASS.get(),RenderType.translucent());
		RenderTypeLookup.setRenderLayer(MAROON_STAINED_GLASS.get(),RenderType.translucent());
		RenderTypeLookup.setRenderLayer(NAVY_STAINED_GLASS.get(),RenderType.translucent());
		RenderTypeLookup.setRenderLayer(OLIVE_STAINED_GLASS.get(),RenderType.translucent());
		RenderTypeLookup.setRenderLayer(PALE_GREEN_STAINED_GLASS.get(),RenderType.translucent());
		RenderTypeLookup.setRenderLayer(PALE_PINK_STAINED_GLASS.get(),RenderType.translucent());
		RenderTypeLookup.setRenderLayer(PALE_YELLOW_STAINED_GLASS.get(),RenderType.translucent());
		RenderTypeLookup.setRenderLayer(SKY_BLUE_STAINED_GLASS.get(),RenderType.translucent());
		RenderTypeLookup.setRenderLayer(SLATE_GRAY_STAINED_GLASS.get(),RenderType.translucent());
		RenderTypeLookup.setRenderLayer(VIOLET_STAINED_GLASS.get(),RenderType.translucent());

		RenderTypeLookup.setRenderLayer(AMBER_STAINED_GLASS_PANE.get(),RenderType.translucent());
		RenderTypeLookup.setRenderLayer(BEIGE_STAINED_GLASS_PANE.get(),RenderType.translucent());
		RenderTypeLookup.setRenderLayer(CREAM_STAINED_GLASS_PANE.get(),RenderType.translucent());
		RenderTypeLookup.setRenderLayer(DARK_GREEN_STAINED_GLASS_PANE.get(),RenderType.translucent());
		RenderTypeLookup.setRenderLayer(FOREST_GREEN_STAINED_GLASS_PANE.get(),RenderType.translucent());
		RenderTypeLookup.setRenderLayer(HOT_PINK_STAINED_GLASS_PANE.get(),RenderType.translucent());
		RenderTypeLookup.setRenderLayer(INDIGO_STAINED_GLASS_PANE.get(),RenderType.translucent());
		RenderTypeLookup.setRenderLayer(MAROON_STAINED_GLASS_PANE.get(),RenderType.translucent());
		RenderTypeLookup.setRenderLayer(NAVY_STAINED_GLASS_PANE.get(),RenderType.translucent());
		RenderTypeLookup.setRenderLayer(OLIVE_STAINED_GLASS_PANE.get(),RenderType.translucent());
		RenderTypeLookup.setRenderLayer(PALE_GREEN_STAINED_GLASS_PANE.get(),RenderType.translucent());
		RenderTypeLookup.setRenderLayer(PALE_PINK_STAINED_GLASS_PANE.get(),RenderType.translucent());
		RenderTypeLookup.setRenderLayer(PALE_YELLOW_STAINED_GLASS_PANE.get(),RenderType.translucent());
		RenderTypeLookup.setRenderLayer(SKY_BLUE_STAINED_GLASS_PANE.get(),RenderType.translucent());
		RenderTypeLookup.setRenderLayer(SLATE_GRAY_STAINED_GLASS_PANE.get(),RenderType.translucent());
		RenderTypeLookup.setRenderLayer(VIOLET_STAINED_GLASS_PANE.get(),RenderType.translucent());
	}
}
