...
public class PropertyUtils {
    ...
    public static final Block.Properties GLAZED_TERRACOTTA = Block.Properties.create(Material.ROCK).hardnessAndResistance(1.4F);
    public static final Block.Properties CONCRETE = Block.Properties.create(Material.ROCK).hardnessAndResistance(1.8F);
    public static final Block.Properties CONCRETE_POWDER = Block.Properties.create(Material.SAND).harvestTool(ToolType.SHOVEL).hardnessAndResistance(0.5F).sound(SoundType.SAND);
    public static final Block.Properties STAINED_GLASS = Block.Properties.create(Material.GLASS).hardnessAndResistance(0.3F).sound(SoundType.GLASS);
